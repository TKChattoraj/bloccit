...
RSpec.describe CommentsController, type: :controller do
  ...
  #  I realize that I am using the factory here and overwriting the body, but I'd prefer not to refactor other parts of the spec when it doesn't seem to give any advantage.
  ...
  context "guest" do
    ...
    describe "DELETE destroy" do
      it "redirects the user to the sing in view" do
